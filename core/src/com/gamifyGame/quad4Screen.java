 ...
 */
public class quad4Screen implements Screen {
    ...
    public quad4Screen(gamifyGame game, ActionResolver actionResolver, renderHelper rendererPassed,
    ...
    public void show() {
        ...
        Image retBox = renderer.imageSetupCenter("48Box.png", layer1, 37, -25);
