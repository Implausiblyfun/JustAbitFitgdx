...
public class ChallengeAlarm extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ActionResolverAndroid actionResolverAndroid = new ActionResolverAndroid(context);
        gamifyGame game = gamifyGame.getGamifyGame(actionResolverAndroid);
        Preferences pref = game.getPrefs();

        // This stuff happens every day at midnight! A lot should happen here!
        // i.e. storing all the data from the last day!
        // getting rid of data that is a week old! // TODO: MAKE THIS GET RID OF OLD DATA
